...
`)+`
<<<<<<< HEAD
`}};e._defineProperty(i,"defaults",y),s.Document=i,s.defaultOptions=h,s.scalarOptions=d}}),Hr=D({"node_modules/yaml/dist/index.js"(s){"use strict";Y();var e=Jr(),r=xr(),c=ot(),h=Me(),d=at();ke();function y(C){let q=arguments.length>1&&arguments[1]!==void 0?arguments[1]:!0,R=arguments.length>2?arguments[2]:void 0;R===void 0&&typeof q=="string"&&(R=q,q=!0);let B=Object.assign({},r.Document.defaults[r.defaultOptions.version],r.defaultOptions);return new c.Schema(B).createNode(C,q,R)}var M=class extends r.Document{constructor(C){super(Object.assign({},r.defaultOptions,C))}};function k(C,q){let R=[],B;for(let U of e.parse(C)){let f=new M(q);f.parse(U,B),R.push(f),B=f}return R}function w(C,q){let R=e.parse(C),B=new M(q).parse(R[0]);if(R.length>1){let U="Source contains multiple documents; please use YAML.parseAllDocuments()";B.errors.unshift(new h.YAMLSemanticError(R[1],U))}return B}function E(C,q){let R=w(C,q);if(R.warnings.forEach(B=>d.warn(B)),R.errors.length>0)throw R.errors[0];return R.toJSON()}function T(C,q){let R=new M(q);return R.contents=C,String(R)}var I={createNode:y,defaultOptions:r.defaultOptions,Document:M,parse:E,parseAllDocuments:k,parseCST:e.parse,parseDocument:w,scalarOptions:r.scalarOptions,stringify:T};s.YAML=I}}),Je=D({"node_modules/yaml/index.js"(s,e){Y(),e.exports=Hr().YAML}}),Gr=D({"node_modules/yaml/dist/util.js"(s){"use strict";Y();var e=ke(),r=Me();s.findPair=e.findPair,s.parseMap=e.resolveMap,s.parseSeq=e.resolveSeq,s.stringifyNumber=e.stringifyNumber,s.stringifyString=e.stringifyString,s.toJSON=e.toJSON,s.Type=r.Type,s.YAMLError=r.YAMLError,s.YAMLReferenceError=r.YAMLReferenceError,s.YAMLSemanticError=r.YAMLSemanticError,s.YAMLSyntaxError=r.YAMLSyntaxError,s.YAMLWarning=r.YAMLWarning}}),zr=D({"node_modules/yaml/util.js"(s){Y();var e=Gr();s.findPair=e.findPair,s.toJSON=e.toJSON,s.parseMap=e.parseMap,s.parseSeq=e.parseSeq,s.stringifyNumber=e.stringifyNumber,s.stringifyString=e.stringifyString,s.Type=e.Type,s.YAMLError=e.YAMLError,s.YAMLReferenceError=e.YAMLReferenceError,s.YAMLSemanticError=e.YAMLSemanticError,s.YAMLSyntaxError=e.YAMLSyntaxError,s.YAMLWarning=e.YAMLWarning}}),Zr=D({"node_modules/yaml-unist-parser/lib/yaml.js"(s){"use strict";Y(),s.__esModule=!0;var e=Je();s.Document=e.Document;var r=Je();s.parseCST=r.parseCST;var c=zr();s.YAMLError=c.YAMLError,s.YAMLSyntaxError=c.YAMLSyntaxError,s.YAMLSemanticError=c.YAMLSemanticError}}),Xr=D({"node_modules/yaml-unist-parser/lib/parse.js"(s){"use strict";Y(),s.__esModule=!0;var e=Kt(),r=xt(),c=Ht(),h=Gt(),d=Br(),y=ze(),M=Yr(),k=Fr(),w=Wr(),E=Vr(),T=Qr(),I=Kr(),C=Zr();function q(R){var B=C.parseCST(R);E.addOrigRange(B);for(var U=B.map(function(P){return new C.Document({merge:!1,keepCstNodes:!0}).parse(P)}),f=new e.default(R),i=[],t={text:R,locator:f,comments:i,transformOffset:function(P){return k.transformOffset(P,t)},transformRange:function(P){return w.transformRange(P,t)},transformNode:function(P){return d.transformNode(P,t)},transformContent:function(P){return y.transformContent(P,t)}},n=0,a=U;n<a.length;n++)for(var m=a[n],p=0,u=m.errors;p<u.length;p++){var g=u[p];if(!(g instanceof C.YAMLSemanticError&&g.message==='Map keys must be unique; "<<" is repeated'))throw M.transformError(g,t)}U.forEach(function(P){return h.removeCstBlankLine(P.cstNode)});var L=c.createRoot(t.transformRange({origStart:0,origEnd:t.text.length}),U.map(t.transformNode),i);return r.attachComments(L),I.updatePositions(L),T.removeFakeNodes(L),L}s.parse=q}}),en=D({"node_modules/yaml-unist-parser/lib/index.js"(s){"use strict";Y(),s.__esModule=!0;var e=(ie(),se(te));e.__exportStar(Xr(),s)}}),tn=D({"src/language-yaml/parser-yaml.js"(s,e){Y();var r=Mt(),{hasPragma:c}=Ot(),{locStart:h,locEnd:d}=Lt();function y(k){let{parse:w}=en();try{let E=w(k);return delete E.comments,E}catch(E){throw E!=null&&E.position?r(E.message,E.position):E}}var M={astFormat:"yaml",parse:y,hasPragma:c,locStart:h,locEnd:d};e.exports={parsers:{yaml:M}}}}),rn=tn();export{rn as default};
=======
