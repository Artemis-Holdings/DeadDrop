<<<<<<< HEAD
"use strict";var k=(n,o)=>()=>(o||n((o={exports:{}}).exports,o),o.exports);var Z=k((Bh,jr)=>{var Ye=function(n){return n&&n.Math==Math&&n};jr.exports=Ye(typeof globalThis=="object"&&globalThis)||Ye(typeof window=="object"&&window)||Ye(typeof self=="object"&&self)||Ye(typeof global=="object"&&global)||function(){return this}()||Function("return this")()});var Ae=k((Th,qr)=>{qr.exports=function(n){try{return!!n()}catch{return!0}}});var Se=k((Ih,Mr)=>{var Za=Ae();Mr.exports=!Za(function(){return Object.defineProperty({},1,{get:function(){return 7}})[1]!=7})});var At=k((Ph,Ur)=>{var en=Ae();Ur.exports=!en(function(){var n=function(){}.bind();return typeof n!="function"||n.hasOwnProperty("prototype")})});var Ze=k((Nh,zr)=>{var tn=At(),$e=Function.prototype.call;zr.exports=tn?$e.bind($e):function(){return $e.apply($e,arguments)}});var Hr=k(Kr=>{"use strict";var Wr={}.propertyIsEnumerable,Gr=Object.getOwnPropertyDescriptor,rn=Gr&&!Wr.call({1:2},1);Kr.f=rn?function(o){var u=Gr(this,o);return!!u&&u.enumerable}:Wr});var Ct=k((Oh,Xr)=>{Xr.exports=function(n,o){return{enumerable:!(n&1),configurable:!(n&2),writable:!(n&4),value:o}}});var fe=k((Lh,Yr)=>{var Jr=At(),Qr=Function.prototype,sn=Qr.bind,Et=Qr.call,an=Jr&&sn.bind(Et,Et);Yr.exports=Jr?function(n){return n&&an(n)}:function(n){return n&&function(){return Et.apply(n,arguments)}}});var ei=k((Vh,Zr)=>{var $r=fe(),nn=$r({}.toString),on=$r("".slice);Zr.exports=function(n){return on(nn(n),8,-1)}});var ri=k((Rh,ti)=>{var un=Z(),hn=fe(),ln=Ae(),cn=ei(),bt=un.Object,pn=hn("".split);ti.exports=ln(function(){return!bt("z").propertyIsEnumerable(0)})?function(n){return cn(n)=="String"?pn(n,""):bt(n)}:bt});var _t=k((jh,ii)=>{var fn=Z(),dn=fn.TypeError;ii.exports=function(n){if(n==null)throw dn("Can't call method on "+n);return n}});var et=k((qh,si)=>{var mn=ri(),vn=_t();si.exports=function(n){return mn(vn(n))}});var de=k((Mh,ai)=>{ai.exports=function(n){return typeof n=="function"}});var Pe=k((Uh,ni)=>{var gn=de();ni.exports=function(n){return typeof n=="object"?n!==null:gn(n)}});var tt=k((zh,oi)=>{var St=Z(),xn=de(),yn=function(n){return xn(n)?n:void 0};oi.exports=function(n,o){return arguments.length<2?yn(St[n]):St[n]&&St[n][o]}});var hi=k((Wh,ui)=>{var An=fe();ui.exports=An({}.isPrototypeOf)});var ci=k((Gh,li)=>{var Cn=tt();li.exports=Cn("navigator","userAgent")||""});var xi=k((Kh,gi)=>{var vi=Z(),wt=ci(),pi=vi.process,fi=vi.Deno,di=pi&&pi.versions||fi&&fi.version,mi=di&&di.v8,le,rt;mi&&(le=mi.split("."),rt=le[0]>0&&le[0]<4?1:+(le[0]+le[1]));!rt&&wt&&(le=wt.match(/Edge\/(\d+)/),(!le||le[1]>=74)&&(le=wt.match(/Chrome\/(\d+)/),le&&(rt=+le[1])));gi.exports=rt});var kt=k((Hh,Ai)=>{var yi=xi(),En=Ae();Ai.exports=!!Object.getOwnPropertySymbols&&!En(function(){var n=Symbol();return!String(n)||!(Object(n)instanceof Symbol)||!Symbol.sham&&yi&&yi<41})});var Ft=k((Xh,Ci)=>{var bn=kt();Ci.exports=bn&&!Symbol.sham&&typeof Symbol.iterator=="symbol"});var Bt=k((Jh,Ei)=>{var _n=Z(),Sn=tt(),wn=de(),kn=hi(),Fn=Ft(),Bn=_n.Object;Ei.exports=Fn?function(n){return typeof n=="symbol"}:function(n){var o=Sn("Symbol");return wn(o)&&kn(o.prototype,Bn(n))}});var _i=k((Qh,bi)=>{var Tn=Z(),In=Tn.String;bi.exports=function(n){try{return In(n)}catch{return"Object"}}});var wi=k((Yh,Si)=>{var Pn=Z(),Nn=de(),Dn=_i(),On=Pn.TypeError;Si.exports=function(n){if(Nn(n))return n;throw On(Dn(n)+" is not a function")}});var Fi=k(($h,ki)=>{var Ln=wi();ki.exports=function(n,o){var u=n[o];return u==null?void 0:Ln(u)}});var Ti=k((Zh,Bi)=>{var Vn=Z(),Tt=Ze(),It=de(),Pt=Pe(),Rn=Vn.TypeError;Bi.exports=function(n,o){var u,l;if(o==="string"&&It(u=n.toString)&&!Pt(l=Tt(u,n))||It(u=n.valueOf)&&!Pt(l=Tt(u,n))||o!=="string"&&It(u=n.toString)&&!Pt(l=Tt(u,n)))return l;throw Rn("Can't convert object to primitive value")}});var Pi=k((el,Ii)=>{Ii.exports=!1});var it=k((tl,Di)=>{var Ni=Z(),jn=Object.defineProperty;Di.exports=function(n,o){try{jn(Ni,n,{value:o,configurable:!0,writable:!0})}catch{Ni[n]=o}return o}});var st=k((rl,Li)=>{var qn=Z(),Mn=it(),Oi="__core-js_shared__",Un=qn[Oi]||Mn(Oi,{});Li.exports=Un});var Nt=k((il,Ri)=>{var zn=Pi(),Vi=st();(Ri.exports=function(n,o){return Vi[n]||(Vi[n]=o!==void 0?o:{})})("versions",[]).push({version:"3.22.2",mode:zn?"pure":"global",copyright:"\xA9 2014-2022 Denis Pushkarev (zloirock.ru)",license:"https://github.com/zloirock/core-js/blob/v3.22.2/LICENSE",source:"https://github.com/zloirock/core-js"})});var qi=k((sl,ji)=>{var Wn=Z(),Gn=_t(),Kn=Wn.Object;ji.exports=function(n){return Kn(Gn(n))}});var Ce=k((al,Mi)=>{var Hn=fe(),Xn=qi(),Jn=Hn({}.hasOwnProperty);Mi.exports=Object.hasOwn||function(o,u){return Jn(Xn(o),u)}});var Dt=k((nl,Ui)=>{var Qn=fe(),Yn=0,$n=Math.random(),Zn=Qn(1 .toString);Ui.exports=function(n){return"Symbol("+(n===void 0?"":n)+")_"+Zn(++Yn+$n,36)}});var Xi=k((ol,Hi)=>{var eo=Z(),to=Nt(),zi=Ce(),ro=Dt(),Wi=kt(),Ki=Ft(),Ne=to("wks"),we=eo.Symbol,Gi=we&&we.for,io=Ki?we:we&&we.withoutSetter||ro;Hi.exports=function(n){if(!zi(Ne,n)||!(Wi||typeof Ne[n]=="string")){var o="Symbol."+n;Wi&&zi(we,n)?Ne[n]=we[n]:Ki&&Gi?Ne[n]=Gi(o):Ne[n]=io(o)}return Ne[n]}});var $i=k((ul,Yi)=>{var so=Z(),ao=Ze(),Ji=Pe(),Qi=Bt(),no=Fi(),oo=Ti(),uo=Xi(),ho=so.TypeError,lo=uo("toPrimitive");Yi.exports=function(n,o){if(!Ji(n)||Qi(n))return n;var u=no(n,lo),l;if(u){if(o===void 0&&(o="default"),l=ao(u,n,o),!Ji(l)||Qi(l))return l;throw ho("Can't convert object to primitive value")}return o===void 0&&(o="number"),oo(n,o)}});var Ot=k((hl,Zi)=>{var co=$i(),po=Bt();Zi.exports=function(n){var o=co(n,"string");return po(o)?o:o+""}});var rs=k((ll,ts)=>{var fo=Z(),es=Pe(),Lt=fo.document,mo=es(Lt)&&es(Lt.createElement);ts.exports=function(n){return mo?Lt.createElement(n):{}}});var Vt=k((cl,is)=>{var vo=Se(),go=Ae(),xo=rs();is.exports=!vo&&!go(function(){return Object.defineProperty(xo("div"),"a",{get:function(){return 7}}).a!=7})});var Rt=k(as=>{var yo=Se(),Ao=Ze(),Co=Hr(),Eo=Ct(),bo=et(),_o=Ot(),So=Ce(),wo=Vt(),ss=Object.getOwnPropertyDescriptor;as.f=yo?ss:function(o,u){if(o=bo(o),u=_o(u),wo)try{return ss(o,u)}catch{}if(So(o,u))return Eo(!Ao(Co.f,o,u),o[u])}});var os=k((fl,ns)=>{var ko=Se(),Fo=Ae();ns.exports=ko&&Fo(function(){return Object.defineProperty(function(){},"prototype",{value:42,writable:!1}).prototype!=42})});var jt=k((dl,hs)=>{var us=Z(),Bo=Pe(),To=us.String,Io=us.TypeError;hs.exports=function(n){if(Bo(n))return n;throw Io(To(n)+" is not an object")}});var Wt=k(cs=>{var Po=Z(),No=Se(),Do=Vt(),Oo=os(),at=jt(),ls=Ot(),Lo=Po.TypeError,qt=Object.defineProperty,Vo=Object.getOwnPropertyDescriptor,Mt="enumerable",Ut="configurable",zt="writable";cs.f=No?Oo?function(o,u,l){if(at(o),u=ls(u),at(l),typeof o=="function"&&u==="prototype"&&"value"in l&&zt in l&&!l[zt]){var v=Vo(o,u);v&&v[zt]&&(o[u]=l.value,l={configurable:Ut in l?l[Ut]:v[Ut],enumerable:Mt in l?l[Mt]:v[Mt],writable:!1})}return qt(o,u,l)}:qt:function(o,u,l){if(at(o),u=ls(u),at(l),Do)try{return qt(o,u,l)}catch{}if("get"in l||"set"in l)throw Lo("Accessors not supported");return"value"in l&&(o[u]=l.value),o}});var nt=k((vl,ps)=>{var Ro=Se(),jo=Wt(),qo=Ct();ps.exports=Ro?function(n,o,u){return jo.f(n,o,qo(1,u))}:function(n,o,u){return n[o]=u,n}});var Kt=k((gl,fs)=>{var Mo=fe(),Uo=de(),Gt=st(),zo=Mo(Function.toString);Uo(Gt.inspectSource)||(Gt.inspectSource=function(n){return zo(n)});fs.exports=Gt.inspectSource});var vs=k((xl,ms)=>{var Wo=Z(),Go=de(),Ko=Kt(),ds=Wo.WeakMap;ms.exports=Go(ds)&&/native code/.test(Ko(ds))});var ys=k((yl,xs)=>{var Ho=Nt(),Xo=Dt(),gs=Ho("keys");xs.exports=function(n){return gs[n]||(gs[n]=Xo(n))}});var Ht=k((Al,As)=>{As.exports={}});var ws=k((Cl,Ss)=>{var Jo=vs(),_s=Z(),Xt=fe(),Qo=Pe(),Yo=nt(),Jt=Ce(),Qt=st(),$o=ys(),Zo=Ht(),Cs="Object already initialized",$t=_s.TypeError,eu=_s.WeakMap,ot,Me,ut,tu=function(n){return ut(n)?Me(n):ot(n,{})},ru=function(n){return function(o){var u;if(!Qo(o)||(u=Me(o)).type!==n)throw $t("Incompatible receiver, "+n+" required");return u}};Jo||Qt.state?(Ee=Qt.state||(Qt.state=new eu),Es=Xt(Ee.get),Yt=Xt(Ee.has),bs=Xt(Ee.set),ot=function(n,o){if(Yt(Ee,n))throw new $t(Cs);return o.facade=n,bs(Ee,n,o),o},Me=function(n){return Es(Ee,n)||{}},ut=function(n){return Yt(Ee,n)}):(ke=$o("state"),Zo[ke]=!0,ot=function(n,o){if(Jt(n,ke))throw new $t(Cs);return o.facade=n,Yo(n,ke,o),o},Me=function(n){return Jt(n,ke)?n[ke]:{}},ut=function(n){return Jt(n,ke)});var Ee,Es,Yt,bs,ke;Ss.exports={set:ot,get:Me,has:ut,enforce:tu,getterFor:ru}});var Bs=k((El,Fs)=>{var Zt=Se(),iu=Ce(),ks=Function.prototype,su=Zt&&Object.getOwnPropertyDescriptor,er=iu(ks,"name"),au=er&&function(){}.name==="something",nu=er&&(!Zt||Zt&&su(ks,"name").configurable);Fs.exports={EXISTS:er,PROPER:au,CONFIGURABLE:nu}});var Ds=k((bl,Ns)=>{var ou=Z(),Ts=de(),uu=Ce(),Is=nt(),hu=it(),lu=Kt(),Ps=ws(),cu=Bs().CONFIGURABLE,pu=Ps.get,fu=Ps.enforce,du=String(String).split("String");(Ns.exports=function(n,o,u,l){var v=l?!!l.unsafe:!1,E=l?!!l.enumerable:!1,x=l?!!l.noTargetGet:!1,b=l&&l.name!==void 0?l.name:o,P;if(Ts(u)&&(String(b).slice(0,7)==="Symbol("&&(b="["+String(b).replace(/^Symbol\(([^)]*)\)/,"$1")+"]"),(!uu(u,"name")||cu&&u.name!==b)&&Is(u,"name",b),P=fu(u),P.source||(P.source=du.join(typeof b=="string"?b:""))),n===ou){E?n[o]=u:hu(o,u);return}else v?!x&&n[o]&&(E=!0):delete n[o];E?n[o]=u:Is(n,o,u)})(Function.prototype,"toString",function(){return Ts(this)&&pu(this).source||lu(this)})});var tr=k((_l,Os)=>{var mu=Math.ceil,vu=Math.floor;Os.exports=function(n){var o=+n;return o!==o||o===0?0:(o>0?vu:mu)(o)}});var Vs=k((Sl,Ls)=>{var gu=tr(),xu=Math.max,yu=Math.min;Ls.exports=function(n,o){var u=gu(n);return u<0?xu(u+o,0):yu(u,o)}});var js=k((wl,Rs)=>{var Au=tr(),Cu=Math.min;Rs.exports=function(n){return n>0?Cu(Au(n),9007199254740991):0}});var Ms=k((kl,qs)=>{var Eu=js();qs.exports=function(n){return Eu(n.length)}});var Ws=k((Fl,zs)=>{var bu=et(),_u=Vs(),Su=Ms(),Us=function(n){return function(o,u,l){var v=bu(o),E=Su(v),x=_u(l,E),b;if(n&&u!=u){for(;E>x;)if(b=v[x++],b!=b)return!0}else for(;E>x;x++)if((n||x in v)&&v[x]===u)return n||x||0;return!n&&-1}};zs.exports={includes:Us(!0),indexOf:Us(!1)}});var Hs=k((Bl,Ks)=>{var wu=fe(),rr=Ce(),ku=et(),Fu=Ws().indexOf,Bu=Ht(),Gs=wu([].push);Ks.exports=function(n,o){var u=ku(n),l=0,v=[],E;for(E in u)!rr(Bu,E)&&rr(u,E)&&Gs(v,E);for(;o.length>l;)rr(u,E=o[l++])&&(~Fu(v,E)||Gs(v,E));return v}});var Js=k((Tl,Xs)=>{Xs.exports=["constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"]});var Ys=k(Qs=>{var Tu=Hs(),Iu=Js(),Pu=Iu.concat("length","prototype");Qs.f=Object.getOwnPropertyNames||function(o){return Tu(o,Pu)}});var Zs=k($s=>{$s.f=Object.getOwnPropertySymbols});var ta=k((Nl,ea)=>{var Nu=tt(),Du=fe(),Ou=Ys(),Lu=Zs(),Vu=jt(),Ru=Du([].concat);ea.exports=Nu("Reflect","ownKeys")||function(o){var u=Ou.f(Vu(o)),l=Lu.f;return l?Ru(u,l(o)):u}});var sa=k((Dl,ia)=>{var ra=Ce(),ju=ta(),qu=Rt(),Mu=Wt();ia.exports=function(n,o,u){for(var l=ju(o),v=Mu.f,E=qu.f,x=0;x<l.length;x++){var b=l[x];!ra(n,b)&&!(u&&ra(u,b))&&v(n,b,E(o,b))}}});var na=k((Ol,aa)=>{var Uu=Ae(),zu=de(),Wu=/#|\.prototype\./,Ue=function(n,o){var u=Ku[Gu(n)];return u==Xu?!0:u==Hu?!1:zu(o)?Uu(o):!!o},Gu=Ue.normalize=function(n){return String(n).replace(Wu,".").toLowerCase()},Ku=Ue.data={},Hu=Ue.NATIVE="N",Xu=Ue.POLYFILL="P";aa.exports=Ue});var ua=k((Ll,oa)=>{var ir=Z(),Ju=Rt().f,Qu=nt(),Yu=Ds(),$u=it(),Zu=sa(),eh=na();oa.exports=function(n,o){var u=n.target,l=n.global,v=n.stat,E,x,b,P,g,N;if(l?x=ir:v?x=ir[u]||$u(u,{}):x=(ir[u]||{}).prototype,x)for(b in o){if(g=o[b],n.noTargetGet?(N=Ju(x,b),P=N&&N.value):P=x[b],E=eh(l?b:u+(v?".":"#")+b,n.forced),!E&&P!==void 0){if(typeof g==typeof P)continue;Zu(g,P)}(n.sham||P&&P.sham)&&Qu(g,"sham",!0),Yu(x,b,g,n)}}});var ha=k(()=>{var th=ua(),rh=Z();th({global:!0},{globalThis:rh})});ha();var or=Object.defineProperty,ih=Object.getOwnPropertyDescriptor,ur=Object.getOwnPropertyNames,sh=Object.prototype.hasOwnProperty,la=(n,o)=>function(){return n&&(o=(0,n[ur(n)[0]])(n=0)),o},Q=(n,o)=>function(){return o||(0,n[ur(n)[0]])((o={exports:{}}).exports,o),o.exports},ah=(n,o)=>{for(var u in o)or(n,u,{get:o[u],enumerable:!0})},nh=(n,o,u,l)=>{if(o&&typeof o=="object"||typeof o=="function")for(let v of ur(o))!sh.call(n,v)&&v!==u&&or(n,v,{get:()=>o[v],enumerable:!(l=ih(o,v))||l.enumerable});return n},oh=n=>nh(or({},"__esModule",{value:!0}),n),J=la({"<define:process>"(){}}),hr=Q({"src/common/parser-create-error.js"(n,o){"use strict";J();function u(l,v){let E=new SyntaxError(l+" ("+v.start.line+":"+v.start.column+")");return E.loc=v,E}o.exports=u}}),ca=Q({"src/utils/try-combinations.js"(n,o){"use strict";J();function u(){let l;for(var v=arguments.length,E=new Array(v),x=0;x<v;x++)E[x]=arguments[x];for(let[b,P]of E.entries())try{return{result:P()}}catch(g){b===0&&(l=g)}return{error:l}}o.exports=u}}),pa={};ah(pa,{EOL:()=>nr,arch:()=>uh,cpus:()=>ya,default:()=>_a,endianness:()=>fa,freemem:()=>ga,getNetworkInterfaces:()=>ba,hostname:()=>da,loadavg:()=>ma,networkInterfaces:()=>Ea,platform:()=>hh,release:()=>Ca,tmpDir:()=>sr,tmpdir:()=>ar,totalmem:()=>xa,type:()=>Aa,uptime:()=>va});function fa(){if(typeof ht>"u"){var n=new ArrayBuffer(2),o=new Uint8Array(n),u=new Uint16Array(n);if(o[0]=1,o[1]=2,u[0]===258)ht="BE";else if(u[0]===513)ht="LE";else throw new Error("unable to figure out endianess")}return ht}function da(){return typeof globalThis.location<"u"?globalThis.location.hostname:""}function ma(){return[]}function va(){return 0}function ga(){return Number.MAX_VALUE}function xa(){return Number.MAX_VALUE}function ya(){return[]}function Aa(){return"Browser"}function Ca(){return typeof globalThis.navigator<"u"?globalThis.navigator.appVersion:""}function Ea(){}function ba(){}function uh(){return"javascript"}function hh(){return"browser"}function sr(){return"/tmp"}var ht,ar,nr,_a,lh=la({"node-modules-polyfills:os"(){J(),ar=sr,nr=`
`,_a={EOL:nr,tmpdir:ar,tmpDir:sr,networkInterfaces:Ea,getNetworkInterfaces:ba,release:Ca,type:Aa,cpus:ya,totalmem:xa,freemem:ga,uptime:va,loadavg:ma,hostname:da,endianness:fa}}}),ch=Q({"node-modules-polyfills-commonjs:os"(n,o){J();var u=(lh(),oh(pa));if(u&&u.default){o.exports=u.default;for(let l in u)o.exports[l]=u[l]}else u&&(o.exports=u)}}),ph=Q({"node_modules/detect-newline/index.js"(n,o){"use strict";J();var u=l=>{if(typeof l!="string")throw new TypeError("Expected a string");let v=l.match(/(?:\r?\n)/g)||[];if(v.length===0)return;let E=v.filter(b=>b===`\r
`).length,x=v.length-E;return E>x?`\r
`:`
`};o.exports=u,o.exports.graceful=l=>typeof l=="string"&&u(l)||`
`}}),fh=Q({"node_modules/jest-docblock/build/index.js"(n){"use strict";J(),Object.defineProperty(n,"__esModule",{value:!0}),n.extract=D,n.parse=L,n.parseWithComments=_,n.print=F,n.strip=d;function o(){let A=ch();return o=function(){return A},A}function u(){let A=l(ph());return u=function(){return A},A}function l(A){return A&&A.__esModule?A:{default:A}}var v=/\*\/$/,E=/^\/\*\*?/,x=/^\s*(\/\*\*?(.|\r?\n)*?\*\/)/,b=/(^|\s+)\/\/([^\r\n]*)/g,P=/^(\r?\n)+/,g=/(?:^|\r?\n) *(@[^\r\n]*?) *\r?\n *(?![^@\r\n]*\/\/[^]*)([^@\r\n\s][^@\r\n]+?) *\r?\n/g,N=/(?:^|\r?\n) *@(\S+) *([^\r\n]*)/g,q=/(\r?\n|^) *\* ?/g,T=[];function D(A){let H=A.match(x);return H?H[0].trimLeft():""}function d(A){let H=A.match(x);return H&&H[0]?A.substring(H[0].length):A}function L(A){return _(A).pragmas}function _(A){let H=(0,u().default)(A)||o().EOL;A=A.replace(E,"").replace(v,"").replace(q,"$1");let R="";for(;R!==A;)R=A,A=A.replace(g,`${H}$1 $2${H}`);A=A.replace(P,"").trimRight();let i=Object.create(null),w=A.replace(N,"").replace(P,"").trimRight(),I;for(;I=N.exec(A);){let M=I[2].replace(b,"");typeof i[I[1]]=="string"||Array.isArray(i[I[1]])?i[I[1]]=T.concat(i[I[1]],M):i[I[1]]=M}return{comments:w,pragmas:i}}function F(A){let{comments:H="",pragmas:R={}}=A,i=(0,u().default)(H)||o().EOL,w="/**",I=" *",M=" */",ee=Object.keys(R),oe=ee.map(se=>B(se,R[se])).reduce((se,De)=>se.concat(De),[]).map(se=>`${I} ${se}${i}`).join("");if(!H){if(ee.length===0)return"";if(ee.length===1&&!Array.isArray(R[ee[0]])){let se=R[ee[0]];return`${w} ${B(ee[0],se)[0]}${M}`}}let te=H.split(i).map(se=>`${I} ${se}`).join(i)+i;return w+i+(H?te:"")+(H&&ee.length?I+i:"")+oe+M}function B(A,H){return T.concat(H).map(R=>`@${A} ${R}`.trim())}}}),dh=Q({"src/common/end-of-line.js"(n,o){"use strict";J();function u(x){let b=x.indexOf("\r");return b>=0?x.charAt(b+1)===`
