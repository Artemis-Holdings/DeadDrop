<<<<<<< HEAD
"use strict";var E=(l,c)=>()=>(c||l((c={exports:{}}).exports,c),c.exports);var J=E((pd,ei)=>{var wt=function(l){return l&&l.Math==Math&&l};ei.exports=wt(typeof globalThis=="object"&&globalThis)||wt(typeof window=="object"&&window)||wt(typeof self=="object"&&self)||wt(typeof global=="object"&&global)||function(){return this}()||Function("return this")()});var ve=E((dd,ti)=>{ti.exports=function(l){try{return!!l()}catch{return!0}}});var _e=E((fd,si)=>{var Ql=ve();si.exports=!Ql(function(){return Object.defineProperty({},1,{get:function(){return 7}})[1]!=7})});var It=E((md,ri)=>{var Zl=ve();ri.exports=!Zl(function(){var l=function(){}.bind();return typeof l!="function"||l.hasOwnProperty("prototype")})});var kt=E((yd,ii)=>{var eh=It(),Nt=Function.prototype.call;ii.exports=eh?Nt.bind(Nt):function(){return Nt.apply(Nt,arguments)}});var li=E(oi=>{"use strict";var ai={}.propertyIsEnumerable,ni=Object.getOwnPropertyDescriptor,th=ni&&!ai.call({1:2},1);oi.f=th?function(c){var d=ni(this,c);return!!d&&d.enumerable}:ai});var ys=E((gd,hi)=>{hi.exports=function(l,c){return{enumerable:!(l&1),configurable:!(l&2),writable:!(l&4),value:c}}});var ce=E((Pd,pi)=>{var ui=It(),ci=Function.prototype,sh=ci.bind,xs=ci.call,rh=ui&&sh.bind(xs,xs);pi.exports=ui?function(l){return l&&rh(l)}:function(l){return l&&function(){return xs.apply(l,arguments)}}});var Dt=E((Ad,fi)=>{var di=ce(),ih=di({}.toString),ah=di("".slice);fi.exports=function(l){return ah(ih(l),8,-1)}});var yi=E((Td,mi)=>{var nh=J(),oh=ce(),lh=ve(),hh=Dt(),gs=nh.Object,uh=oh("".split);mi.exports=lh(function(){return!gs("z").propertyIsEnumerable(0)})?function(l){return hh(l)=="String"?uh(l,""):gs(l)}:gs});var Ps=E((vd,xi)=>{var ch=J(),ph=ch.TypeError;xi.exports=function(l){if(l==null)throw ph("Can't call method on "+l);return l}});var Ft=E((Ed,gi)=>{var dh=yi(),fh=Ps();gi.exports=function(l){return dh(fh(l))}});var pe=E((bd,Pi)=>{Pi.exports=function(l){return typeof l=="function"}});var Re=E((Cd,Ai)=>{var mh=pe();Ai.exports=function(l){return typeof l=="object"?l!==null:mh(l)}});var nt=E((Sd,Ti)=>{var As=J(),yh=pe(),xh=function(l){return yh(l)?l:void 0};Ti.exports=function(l,c){return arguments.length<2?xh(As[l]):As[l]&&As[l][c]}});var Ei=E((wd,vi)=>{var gh=ce();vi.exports=gh({}.isPrototypeOf)});var Ci=E((Id,bi)=>{var Ph=nt();bi.exports=Ph("navigator","userAgent")||""});var Fi=E((Nd,Di)=>{var ki=J(),Ts=Ci(),Si=ki.process,wi=ki.Deno,Ii=Si&&Si.versions||wi&&wi.version,Ni=Ii&&Ii.v8,fe,Lt;Ni&&(fe=Ni.split("."),Lt=fe[0]>0&&fe[0]<4?1:+(fe[0]+fe[1]));!Lt&&Ts&&(fe=Ts.match(/Edge\/(\d+)/),(!fe||fe[1]>=74)&&(fe=Ts.match(/Chrome\/(\d+)/),fe&&(Lt=+fe[1])));Di.exports=Lt});var vs=E((kd,Oi)=>{var Li=Fi(),Ah=ve();Oi.exports=!!Object.getOwnPropertySymbols&&!Ah(function(){var l=Symbol();return!String(l)||!(Object(l)instanceof Symbol)||!Symbol.sham&&Li&&Li<41})});var Es=E((Dd,Mi)=>{var Th=vs();Mi.exports=Th&&!Symbol.sham&&typeof Symbol.iterator=="symbol"});var bs=E((Fd,Bi)=>{var vh=J(),Eh=nt(),bh=pe(),Ch=Ei(),Sh=Es(),wh=vh.Object;Bi.exports=Sh?function(l){return typeof l=="symbol"}:function(l){var c=Eh("Symbol");return bh(c)&&Ch(c.prototype,wh(l))}});var Ri=E((Ld,_i)=>{var Ih=J(),Nh=Ih.String;_i.exports=function(l){try{return Nh(l)}catch{return"Object"}}});var Ot=E((Od,ji)=>{var kh=J(),Dh=pe(),Fh=Ri(),Lh=kh.TypeError;ji.exports=function(l){if(Dh(l))return l;throw Lh(Fh(l)+" is not a function")}});var Ui=E((Md,qi)=>{var Oh=Ot();qi.exports=function(l,c){var d=l[c];return d==null?void 0:Oh(d)}});var $i=E((Bd,Hi)=>{var Mh=J(),Cs=kt(),Ss=pe(),ws=Re(),Bh=Mh.TypeError;Hi.exports=function(l,c){var d,f;if(c==="string"&&Ss(d=l.toString)&&!ws(f=Cs(d,l))||Ss(d=l.valueOf)&&!ws(f=Cs(d,l))||c!=="string"&&Ss(d=l.toString)&&!ws(f=Cs(d,l)))return f;throw Bh("Can't convert object to primitive value")}});var Vi=E((_d,zi)=>{zi.exports=!1});var Mt=E((Rd,Wi)=>{var Ki=J(),_h=Object.defineProperty;Wi.exports=function(l,c){try{_h(Ki,l,{value:c,configurable:!0,writable:!0})}catch{Ki[l]=c}return c}});var Bt=E((jd,Ji)=>{var Rh=J(),jh=Mt(),Gi="__core-js_shared__",qh=Rh[Gi]||jh(Gi,{});Ji.exports=qh});var Is=E((qd,Yi)=>{var Uh=Vi(),Xi=Bt();(Yi.exports=function(l,c){return Xi[l]||(Xi[l]=c!==void 0?c:{})})("versions",[]).push({version:"3.22.2",mode:Uh?"pure":"global",copyright:"\xA9 2014-2022 Denis Pushkarev (zloirock.ru)",license:"https://github.com/zloirock/core-js/blob/v3.22.2/LICENSE",source:"https://github.com/zloirock/core-js"})});var Ns=E((Ud,Qi)=>{var Hh=J(),$h=Ps(),zh=Hh.Object;Qi.exports=function(l){return zh($h(l))}});var Ne=E((Hd,Zi)=>{var Vh=ce(),Kh=Ns(),Wh=Vh({}.hasOwnProperty);Zi.exports=Object.hasOwn||function(c,d){return Wh(Kh(c),d)}});var ks=E(($d,ea)=>{var Gh=ce(),Jh=0,Xh=Math.random(),Yh=Gh(1 .toString);ea.exports=function(l){return"Symbol("+(l===void 0?"":l)+")_"+Yh(++Jh+Xh,36)}});var ot=E((zd,aa)=>{var Qh=J(),Zh=Is(),ta=Ne(),eu=ks(),sa=vs(),ia=Es(),Xe=Zh("wks"),je=Qh.Symbol,ra=je&&je.for,tu=ia?je:je&&je.withoutSetter||eu;aa.exports=function(l){if(!ta(Xe,l)||!(sa||typeof Xe[l]=="string")){var c="Symbol."+l;sa&&ta(je,l)?Xe[l]=je[l]:ia&&ra?Xe[l]=ra(c):Xe[l]=tu(c)}return Xe[l]}});var ha=E((Vd,la)=>{var su=J(),ru=kt(),na=Re(),oa=bs(),iu=Ui(),au=$i(),nu=ot(),ou=su.TypeError,lu=nu("toPrimitive");la.exports=function(l,c){if(!na(l)||oa(l))return l;var d=iu(l,lu),f;if(d){if(c===void 0&&(c="default"),f=ru(d,l,c),!na(f)||oa(f))return f;throw ou("Can't convert object to primitive value")}return c===void 0&&(c="number"),au(l,c)}});var Ds=E((Kd,ua)=>{var hu=ha(),uu=bs();ua.exports=function(l){var c=hu(l,"string");return uu(c)?c:c+""}});var da=E((Wd,pa)=>{var cu=J(),ca=Re(),Fs=cu.document,pu=ca(Fs)&&ca(Fs.createElement);pa.exports=function(l){return pu?Fs.createElement(l):{}}});var Ls=E((Gd,fa)=>{var du=_e(),fu=ve(),mu=da();fa.exports=!du&&!fu(function(){return Object.defineProperty(mu("div"),"a",{get:function(){return 7}}).a!=7})});var Os=E(ya=>{var yu=_e(),xu=kt(),gu=li(),Pu=ys(),Au=Ft(),Tu=Ds(),vu=Ne(),Eu=Ls(),ma=Object.getOwnPropertyDescriptor;ya.f=yu?ma:function(c,d){if(c=Au(c),d=Tu(d),Eu)try{return ma(c,d)}catch{}if(vu(c,d))return Pu(!xu(gu.f,c,d),c[d])}});var ga=E((Xd,xa)=>{var bu=_e(),Cu=ve();xa.exports=bu&&Cu(function(){return Object.defineProperty(function(){},"prototype",{value:42,writable:!1}).prototype!=42})});var Ms=E((Yd,Aa)=>{var Pa=J(),Su=Re(),wu=Pa.String,Iu=Pa.TypeError;Aa.exports=function(l){if(Su(l))return l;throw Iu(wu(l)+" is not an object")}});var qs=E(va=>{var Nu=J(),ku=_e(),Du=Ls(),Fu=ga(),_t=Ms(),Ta=Ds(),Lu=Nu.TypeError,Bs=Object.defineProperty,Ou=Object.getOwnPropertyDescriptor,_s="enumerable",Rs="configurable",js="writable";va.f=ku?Fu?function(c,d,f){if(_t(c),d=Ta(d),_t(f),typeof c=="function"&&d==="prototype"&&"value"in f&&js in f&&!f[js]){var x=Ou(c,d);x&&x[js]&&(c[d]=f.value,f={configurable:Rs in f?f[Rs]:x[Rs],enumerable:_s in f?f[_s]:x[_s],writable:!1})}return Bs(c,d,f)}:Bs:function(c,d,f){if(_t(c),d=Ta(d),_t(f),Du)try{return Bs(c,d,f)}catch{}if("get"in f||"set"in f)throw Lu("Accessors not supported");return"value"in f&&(c[d]=f.value),c}});var Rt=E((Zd,Ea)=>{var Mu=_e(),Bu=qs(),_u=ys();Ea.exports=Mu?function(l,c,d){return Bu.f(l,c,_u(1,d))}:function(l,c,d){return l[c]=d,l}});var jt=E((ef,ba)=>{var Ru=ce(),ju=pe(),Us=Bt(),qu=Ru(Function.toString);ju(Us.inspectSource)||(Us.inspectSource=function(l){return qu(l)});ba.exports=Us.inspectSource});var wa=E((tf,Sa)=>{var Uu=J(),Hu=pe(),$u=jt(),Ca=Uu.WeakMap;Sa.exports=Hu(Ca)&&/native code/.test($u(Ca))});var ka=E((sf,Na)=>{var zu=Is(),Vu=ks(),Ia=zu("keys");Na.exports=function(l){return Ia[l]||(Ia[l]=Vu(l))}});var Hs=E((rf,Da)=>{Da.exports={}});var _a=E((af,Ba)=>{var Ku=wa(),Ma=J(),$s=ce(),Wu=Re(),Gu=Rt(),zs=Ne(),Vs=Bt(),Ju=ka(),Xu=Hs(),Fa="Object already initialized",Ws=Ma.TypeError,Yu=Ma.WeakMap,qt,lt,Ut,Qu=function(l){return Ut(l)?lt(l):qt(l,{})},Zu=function(l){return function(c){var d;if(!Wu(c)||(d=lt(c)).type!==l)throw Ws("Incompatible receiver, "+l+" required");return d}};Ku||Vs.state?(ke=Vs.state||(Vs.state=new Yu),La=$s(ke.get),Ks=$s(ke.has),Oa=$s(ke.set),qt=function(l,c){if(Ks(ke,l))throw new Ws(Fa);return c.facade=l,Oa(ke,l,c),c},lt=function(l){return La(ke,l)||{}},Ut=function(l){return Ks(ke,l)}):(qe=Ju("state"),Xu[qe]=!0,qt=function(l,c){if(zs(l,qe))throw new Ws(Fa);return c.facade=l,Gu(l,qe,c),c},lt=function(l){return zs(l,qe)?l[qe]:{}},Ut=function(l){return zs(l,qe)});var ke,La,Ks,Oa,qe;Ba.exports={set:qt,get:lt,has:Ut,enforce:Qu,getterFor:Zu}});var qa=E((nf,ja)=>{var Gs=_e(),ec=Ne(),Ra=Function.prototype,tc=Gs&&Object.getOwnPropertyDescriptor,Js=ec(Ra,"name"),sc=Js&&function(){}.name==="something",rc=Js&&(!Gs||Gs&&tc(Ra,"name").configurable);ja.exports={EXISTS:Js,PROPER:sc,CONFIGURABLE:rc}});var Va=E((of,za)=>{var ic=J(),Ua=pe(),ac=Ne(),Ha=Rt(),nc=Mt(),oc=jt(),$a=_a(),lc=qa().CONFIGURABLE,hc=$a.get,uc=$a.enforce,cc=String(String).split("String");(za.exports=function(l,c,d,f){var x=f?!!f.unsafe:!1,g=f?!!f.enumerable:!1,A=f?!!f.noTargetGet:!1,T=f&&f.name!==void 0?f.name:c,S;if(Ua(d)&&(String(T).slice(0,7)==="Symbol("&&(T="["+String(T).replace(/^Symbol\(([^)]*)\)/,"$1")+"]"),(!ac(d,"name")||lc&&d.name!==T)&&Ha(d,"name",T),S=uc(d),S.source||(S.source=cc.join(typeof T=="string"?T:""))),l===ic){g?l[c]=d:nc(c,d);return}else x?!A&&l[c]&&(g=!0):delete l[c];g?l[c]=d:Ha(l,c,d)})(Function.prototype,"toString",function(){return Ua(this)&&hc(this).source||oc(this)})});var Xs=E((lf,Ka)=>{var pc=Math.ceil,dc=Math.floor;Ka.exports=function(l){var c=+l;return c!==c||c===0?0:(c>0?dc:pc)(c)}});var Ga=E((hf,Wa)=>{var fc=Xs(),mc=Math.max,yc=Math.min;Wa.exports=function(l,c){var d=fc(l);return d<0?mc(d+c,0):yc(d,c)}});var Xa=E((uf,Ja)=>{var xc=Xs(),gc=Math.min;Ja.exports=function(l){return l>0?gc(xc(l),9007199254740991):0}});var Ht=E((cf,Ya)=>{var Pc=Xa();Ya.exports=function(l){return Pc(l.length)}});var en=E((pf,Za)=>{var Ac=Ft(),Tc=Ga(),vc=Ht(),Qa=function(l){return function(c,d,f){var x=Ac(c),g=vc(x),A=Tc(f,g),T;if(l&&d!=d){for(;g>A;)if(T=x[A++],T!=T)return!0}else for(;g>A;A++)if((l||A in x)&&x[A]===d)return l||A||0;return!l&&-1}};Za.exports={includes:Qa(!0),indexOf:Qa(!1)}});var rn=E((df,sn)=>{var Ec=ce(),Ys=Ne(),bc=Ft(),Cc=en().indexOf,Sc=Hs(),tn=Ec([].push);sn.exports=function(l,c){var d=bc(l),f=0,x=[],g;for(g in d)!Ys(Sc,g)&&Ys(d,g)&&tn(x,g);for(;c.length>f;)Ys(d,g=c[f++])&&(~Cc(x,g)||tn(x,g));return x}});var nn=E((ff,an)=>{an.exports=["constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"]});var ln=E(on=>{var wc=rn(),Ic=nn(),Nc=Ic.concat("length","prototype");on.f=Object.getOwnPropertyNames||function(c){return wc(c,Nc)}});var un=E(hn=>{hn.f=Object.getOwnPropertySymbols});var pn=E((xf,cn)=>{var kc=nt(),Dc=ce(),Fc=ln(),Lc=un(),Oc=Ms(),Mc=Dc([].concat);cn.exports=kc("Reflect","ownKeys")||function(c){var d=Fc.f(Oc(c)),f=Lc.f;return f?Mc(d,f(c)):d}});var mn=E((gf,fn)=>{var dn=Ne(),Bc=pn(),_c=Os(),Rc=qs();fn.exports=function(l,c,d){for(var f=Bc(c),x=Rc.f,g=_c.f,A=0;A<f.length;A++){var T=f[A];!dn(l,T)&&!(d&&dn(d,T))&&x(l,T,g(c,T))}}});var xn=E((Pf,yn)=>{var jc=ve(),qc=pe(),Uc=/#|\.prototype\./,ht=function(l,c){var d=$c[Hc(l)];return d==Vc?!0:d==zc?!1:qc(c)?jc(c):!!c},Hc=ht.normalize=function(l){return String(l).replace(Uc,".").toLowerCase()},$c=ht.data={},zc=ht.NATIVE="N",Vc=ht.POLYFILL="P";yn.exports=ht});var Zs=E((Af,gn)=>{var Qs=J(),Kc=Os().f,Wc=Rt(),Gc=Va(),Jc=Mt(),Xc=mn(),Yc=xn();gn.exports=function(l,c){var d=l.target,f=l.global,x=l.stat,g,A,T,S,O,I;if(f?A=Qs:x?A=Qs[d]||Jc(d,{}):A=(Qs[d]||{}).prototype,A)for(T in c){if(O=c[T],l.noTargetGet?(I=Kc(A,T),S=I&&I.value):S=A[T],g=Yc(f?T:d+(x?".":"#")+T,l.forced),!g&&S!==void 0){if(typeof O==typeof S)continue;Xc(O,S)}(l.sham||S&&S.sham)&&Wc(O,"sham",!0),Gc(A,T,O,l)}}});var Pn=E(()=>{var Qc=Zs(),Zc=J();Qc({global:!0},{globalThis:Zc})});var er=E((Ef,An)=>{var ep=Dt();An.exports=Array.isArray||function(c){return ep(c)=="Array"}});var En=E((bf,vn)=>{var Tn=ce(),tp=Ot(),sp=It(),rp=Tn(Tn.bind);vn.exports=function(l,c){return tp(l),c===void 0?l:sp?rp(l,c):function(){return l.apply(c,arguments)}}});var Sn=E((Cf,Cn)=>{"use strict";var ip=J(),ap=er(),np=Ht(),op=En(),lp=ip.TypeError,bn=function(l,c,d,f,x,g,A,T){for(var S=x,O=0,I=A?op(A,T):!1,C,F;O<f;){if(O in d){if(C=I?I(d[O],O,c):d[O],g>0&&ap(C))F=np(C),S=bn(l,c,C,F,S,g-1)-1;else{if(S>=9007199254740991)throw lp("Exceed the acceptable array length");l[S]=C}S++}O++}return S};Cn.exports=bn});var Nn=E((Sf,In)=>{var hp=ot(),up=hp("toStringTag"),wn={};wn[up]="z";In.exports=String(wn)==="[object z]"});var Dn=E((wf,kn)=>{var cp=J(),pp=Nn(),dp=pe(),$t=Dt(),fp=ot(),mp=fp("toStringTag"),yp=cp.Object,xp=$t(function(){return arguments}())=="Arguments",gp=function(l,c){try{return l[c]}catch{}};kn.exports=pp?$t:function(l){var c,d,f;return l===void 0?"Undefined":l===null?"Null":typeof(d=gp(c=yp(l),mp))=="string"?d:xp?$t(c):(f=$t(c))=="Object"&&dp(c.callee)?"Arguments":f}});var _n=E((If,Bn)=>{var Pp=ce(),Ap=ve(),Fn=pe(),Tp=Dn(),vp=nt(),Ep=jt(),Ln=function(){},bp=[],On=vp("Reflect","construct"),tr=/^\s*(?:class|function)\b/,Cp=Pp(tr.exec),Sp=!tr.exec(Ln),ut=function(c){if(!Fn(c))return!1;try{return On(Ln,bp,c),!0}catch{return!1}},Mn=function(c){if(!Fn(c))return!1;switch(Tp(c)){case"AsyncFunction":case"GeneratorFunction":case"AsyncGeneratorFunction":return!1}try{return Sp||!!Cp(tr,Ep(c))}catch{return!0}};Mn.sham=!0;Bn.exports=!On||Ap(function(){var l;return ut(ut.call)||!ut(Object)||!ut(function(){l=!0})||l})?Mn:ut});var Un=E((Nf,qn)=>{var wp=J(),Rn=er(),Ip=_n(),Np=Re(),kp=ot(),Dp=kp("species"),jn=wp.Array;qn.exports=function(l){var c;return Rn(l)&&(c=l.constructor,Ip(c)&&(c===jn||Rn(c.prototype))?c=void 0:Np(c)&&(c=c[Dp],c===null&&(c=void 0))),c===void 0?jn:c}});var $n=E((kf,Hn)=>{var Fp=Un();Hn.exports=function(l,c){return new(Fp(l))(c===0?0:c)}});Pn();var Lp=Zs(),Op=Sn(),Mp=Ot(),Bp=Ns(),_p=Ht(),Rp=$n();Lp({target:"Array",proto:!0},{flatMap:function(c){var d=Bp(this),f=_p(d),x;return Mp(c),x=Rp(d,0),x.length=Op(x,d,d,f,0,1,c,arguments.length>1?arguments[1]:void 0),x}});var ar=Object.defineProperty,jp=Object.getOwnPropertyDescriptor,nr=Object.getOwnPropertyNames,qp=Object.prototype.hasOwnProperty,zn=(l,c)=>function(){return l&&(c=(0,l[nr(l)[0]])(l=0)),c},W=(l,c)=>function(){return c||(0,l[nr(l)[0]])((c={exports:{}}).exports,c),c.exports},Up=(l,c)=>{for(var d in c)ar(l,d,{get:c[d],enumerable:!0})},Hp=(l,c,d,f)=>{if(c&&typeof c=="object"||typeof c=="function")for(let x of nr(c))!qp.call(l,x)&&x!==d&&ar(l,x,{get:()=>c[x],enumerable:!(f=jp(c,x))||f.enumerable});return l},$p=l=>Hp(ar({},"__esModule",{value:!0}),l),K=zn({"<define:process>"(){}}),zp=W({"src/utils/try-combinations.js"(l,c){"use strict";K();function d(){let f;for(var x=arguments.length,g=new Array(x),A=0;A<x;A++)g[A]=arguments[A];for(let[T,S]of g.entries())try{return{result:S()}}catch(O){T===0&&(f=O)}return{error:f}}c.exports=d}}),Vn=W({"src/language-js/utils/get-shebang.js"(l,c){"use strict";K();function d(f){if(!f.startsWith("#!"))return"";let x=f.indexOf(`
`);return x===-1?f:f.slice(0,x)}c.exports=d}}),Vp=W({"src/utils/text/skip-inline-comment.js"(l,c){"use strict";K();function d(f,x){if(x===!1)return!1;if(f.charAt(x)==="/"&&f.charAt(x+1)==="*"){for(let g=x+2;g<f.length;++g)if(f.charAt(g)==="*"&&f.charAt(g+1)==="/")return g+2}return x}c.exports=d}}),Kp=W({"src/utils/text/skip-newline.js"(l,c){"use strict";K();function d(f,x,g){let A=g&&g.backwards;if(x===!1)return!1;let T=f.charAt(x);if(A){if(f.charAt(x-1)==="\r"&&T===`
`)return x-2;if(T===`
`||T==="\r"||T==="\u2028"||T==="\u2029")return x-1}else{if(T==="\r"&&f.charAt(x+1)===`
`)return x+2;if(T===`
`||T==="\r"||T==="\u2028"||T==="\u2029")return x+1}return x}c.exports=d}}),Kn=W({"src/utils/text/skip.js"(l,c){"use strict";K();function d(T){return(S,O,I)=>{let C=I&&I.backwards;if(O===!1)return!1;let{length:F}=S,_=O;for(;_>=0&&_<F;){let N=S.charAt(_);if(T instanceof RegExp){if(!T.test(N))return _}else if(!T.includes(N))return _;C?_--:_++}return _===-1||_===F?_:!1}}var f=d(/\s/),x=d(" 	"),g=d(",; 	"),A=d(/[^\n\r]/);c.exports={skipWhitespace:f,skipSpaces:x,skipToLineEnd:g,skipEverythingButNewLine:A}}}),Wp=W({"src/utils/text/skip-trailing-comment.js"(l,c){"use strict";K();var{skipEverythingButNewLine:d}=Kn();function f(x,g){return g===!1?!1:x.charAt(g)==="/"&&x.charAt(g+1)==="/"?d(x,g):g}c.exports=f}}),Gp=W({"src/utils/text/get-next-non-space-non-comment-character-index-with-start-index.js"(l,c){"use strict";K();var d=Vp(),f=Kp(),x=Wp(),{skipSpaces:g}=Kn();function A(T,S){let O=null,I=S;for(;I!==O;)O=I,I=g(T,I),I=d(T,I),I=x(T,I),I=f(T,I);return I}c.exports=A}}),Wn={};Up(Wn,{EOL:()=>ir,arch:()=>Jp,cpus:()=>eo,default:()=>ao,endianness:()=>Gn,freemem:()=>Qn,getNetworkInterfaces:()=>io,hostname:()=>Jn,loadavg:()=>Xn,networkInterfaces:()=>ro,platform:()=>Xp,release:()=>so,tmpDir:()=>sr,tmpdir:()=>rr,totalmem:()=>Zn,type:()=>to,uptime:()=>Yn});function Gn(){if(typeof zt>"u"){var l=new ArrayBuffer(2),c=new Uint8Array(l),d=new Uint16Array(l);if(c[0]=1,c[1]=2,d[0]===258)zt="BE";else if(d[0]===513)zt="LE";else throw new Error("unable to figure out endianess")}return zt}function Jn(){return typeof globalThis.location<"u"?globalThis.location.hostname:""}function Xn(){return[]}function Yn(){return 0}function Qn(){return Number.MAX_VALUE}function Zn(){return Number.MAX_VALUE}function eo(){return[]}function to(){return"Browser"}function so(){return typeof globalThis.navigator<"u"?globalThis.navigator.appVersion:""}function ro(){}function io(){}function Jp(){return"javascript"}function Xp(){return"browser"}function sr(){return"/tmp"}var zt,rr,ir,ao,Yp=zn({"node-modules-polyfills:os"(){K(),rr=sr,ir=`
`,ao={EOL:ir,tmpdir:rr,tmpDir:sr,networkInterfaces:ro,getNetworkInterfaces:io,release:so,type:to,cpus:eo,totalmem:Zn,freemem:Qn,uptime:Yn,loadavg:Xn,hostname:Jn,endianness:Gn}}}),Qp=W({"node-modules-polyfills-commonjs:os"(l,c){K();var d=(Yp(),$p(Wn));if(d&&d.default){c.exports=d.default;for(let f in d)c.exports[f]=d[f]}else d&&(c.exports=d)}}),Zp=W({"node_modules/detect-newline/index.js"(l,c){"use strict";K();var d=f=>{if(typeof f!="string")throw new TypeError("Expected a string");let x=f.match(/(?:\r?\n)/g)||[];if(x.length===0)return;let g=x.filter(T=>T===`\r
`).length,A=x.length-g;return g>A?`\r
`:`
`};c.exports=d,c.exports.graceful=f=>typeof f=="string"&&d(f)||`
`}}),ed=W({"node_modules/jest-docblock/build/index.js"(l){"use strict";K(),Object.defineProperty(l,"__esModule",{value:!0}),l.extract=_,l.parse=$,l.parseWithComments=X,l.print=L,l.strip=N;function c(){let h=Qp();return c=function(){return h},h}function d(){let h=f(Zp());return d=function(){return h},h}function f(h){return h&&h.__esModule?h:{default:h}}var x=/\*\/$/,g=/^\/\*\*?/,A=/^\s*(\/\*\*?(.|\r?\n)*?\*\/)/,T=/(^|\s+)\/\/([^\r\n]*)/g,S=/^(\r?\n)+/,O=/(?:^|\r?\n) *(@[^\r\n]*?) *\r?\n *(?![^@\r\n]*\/\/[^]*)([^@\r\n\s][^@\r\n]+?) *\r?\n/g,I=/(?:^|\r?\n) *@(\S+) *([^\r\n]*)/g,C=/(\r?\n|^) *\* ?/g,F=[];function _(h){let Y=h.match(A);return Y?Y[0].trimLeft():""}function N(h){let Y=h.match(A);return Y&&Y[0]?h.substring(Y[0].length):h}function $(h){return X(h).pragmas}function X(h){let Y=(0,d().default)(h)||c().EOL;h=h.replace(g,"").replace(x,"").replace(C,"$1");let oe="";for(;oe!==h;)oe=h,h=h.replace(O,`${Y}$1 $2${Y}`);h=h.replace(S,"").trimRight();let Z=Object.create(null),Ee=h.replace(I,"").replace(S,"").trimRight(),te;for(;te=I.exec(h);){let U=te[2].replace(T,"");typeof Z[te[1]]=="string"||Array.isArray(Z[te[1]])?Z[te[1]]=F.concat(Z[te[1]],U):Z[te[1]]=U}return{comments:Ee,pragmas:Z}}function L(h){let{comments:Y="",pragmas:oe={}}=h,Z=(0,d().default)(Y)||c().EOL,Ee="/**",te=" *",U=" */",M=Object.keys(oe),v=M.map(V=>R(V,oe[V])).reduce((V,Q)=>V.concat(Q),[]).map(V=>`${te} ${V}${Z}`).join("");if(!Y){if(M.length===0)return"";if(M.length===1&&!Array.isArray(oe[M[0]])){let V=oe[M[0]];return`${Ee} ${R(M[0],V)[0]}${U}`}}let De=Y.split(Z).map(V=>`${te} ${V}`).join(Z)+Z;return Ee+Z+(Y?De:"")+(Y&&M.length?te+Z:"")+v+U}function R(h,Y){return F.concat(Y).map(oe=>`@${h} ${oe}`.trim())}}}),td=W({"src/common/end-of-line.js"(l,c){"use strict";K();function d(A){let T=A.indexOf("\r");return T>=0?A.charAt(T+1)===`
`?"crlf":"cr":"lf"}function f(A){switch(A){case"cr":return"\r";case"crlf":return`\r
`;default:return`
`}}function x(A,T){let S;switch(T){case`
`:S=/\n/g;break;case"\r":S=/\r/g;break;case`\r
`:S=/\r\n/g;break;default:throw new Error(`Unexpected "eol" ${JSON.stringify(T)}.`)}let O=A.match(S);return O?O.length:0}function g(A){return A.replace(/\r\n?/g,`
`)}c.exports={guessEndOfLine:d,convertEndOfLineToChars:f,countEndOfLineChars:x,normalizeEndOfLine:g}}}),sd=W({"src/language-js/pragma.js"(l,c){"use strict";K();var{parseWithComments:d,strip:f,extract:x,print:g}=ed(),{normalizeEndOfLine:A}=td(),T=Vn();function S(C){let F=T(C);F&&(C=C.slice(F.length+1));let _=x(C),{pragmas:N,comments:$}=d(_);return{shebang:F,text:C,pragmas:N,comments:$}}function O(C){let F=Object.keys(S(C).pragmas);return F.includes("prettier")||F.includes("format")}function I(C){let{shebang:F,text:_,pragmas:N,comments:$}=S(C),X=f(_),L=g({pragmas:Object.assign({format:""},N),comments:$.trimStart()});return(F?`${F}
`:"")+A(L)+(X.startsWith(`
`)?`
`:`

`)+X}c.exports={hasPragma:O,insertPragma:I}}}),or=W({"src/utils/is-non-empty-array.js"(l,c){"use strict";K();function d(f){return Array.isArray(f)&&f.length>0}c.exports=d}}),no=W({"src/language-js/loc.js"(l,c){"use strict";K();var d=or();function f(S){var O,I;let C=S.range?S.range[0]:S.start,F=(O=(I=S.declaration)===null||I===void 0?void 0:I.decorators)!==null&&O!==void 0?O:S.decorators;return d(F)?Math.min(f(F[0]),C):C}function x(S){return S.range?S.range[1]:S.end}function g(S,O){let I=f(S);return Number.isInteger(I)&&I===f(O)}function A(S,O){let I=x(S);return Number.isInteger(I)&&I===x(O)}function T(S,O){return g(S,O)&&A(S,O)}c.exports={locStart:f,locEnd:x,hasSameLocStart:g,hasSameLoc:T}}}),oo=W({"src/language-js/parse/utils/create-parser.js"(l,c){"use strict";K();var{hasPragma:d}=sd(),{locStart:f,locEnd:x}=no();function g(A){return A=typeof A=="function"?{parse:A}:A,Object.assign({astFormat:"estree",hasPragma:d,locStart:f,locEnd:x},A)}c.exports=g}}),lr=W({"src/common/parser-create-error.js"(l,c){"use strict";K();function d(f,x){let g=new SyntaxError(f+" ("+x.start.line+":"+x.start.column+")");return g.loc=x,g}c.exports=d}}),lo=W({"src/language-js/parse/utils/create-babel-parse-error.js"(l,c){"use strict";K();var d=lr();function f(x){let{message:g,loc:A}=x;return d(g.replace(/ \(.*\)/,""),{start:{line:A?A.line:0,column:A?A.column+1:0}})}c.exports=f}}),rd=W({"src/language-js/utils/is-ts-keyword-type.js"(l,c){"use strict";K();function d(f){let{type:x}=f;return x.startsWith("TS")&&x.endsWith("Keyword")}c.exports=d}}),id=W({"src/language-js/utils/is-block-comment.js"(l,c){"use strict";K();var d=new Set(["Block","CommentBlock","MultiLine"]),f=x=>d.has(x==null?void 0:x.type);c.exports=f}}),ad=W({"src/language-js/utils/is-type-cast-comment.js"(l,c){"use strict";K();var d=id();function f(x){return d(x)&&x.value[0]==="*"&&/@type\b/.test(x.value)}c.exports=f}}),nd=W({"src/utils/get-last.js"(l,c){"use strict";K();var d=f=>f[f.length-1];c.exports=d}}),ho=W({"src/language-js/parse/postprocess/visit-node.js"(l,c){"use strict";K();function d(f,x){if(Array.isArray(f)){for(let g=0;g<f.length;g++)f[g]=d(f[g],x);return f}if(f&&typeof f=="object"&&typeof f.type=="string"){let g=Object.keys(f);for(let A=0;A<g.length;A++)f[g[A]]=d(f[g[A]],x);return x(f)||f}return f}c.exports=d}}),uo=W({"src/language-js/parse/postprocess/throw-syntax-error.js"(l,c){"use strict";K();var d=lr();function f(x,g){let{start:A,end:T}=x.loc;throw d(g,{start:{line:A.line,column:A.column+1},end:{line:T.line,column:T.column+1}})}c.exports=f}}),od=W({"src/language-js/parse/postprocess/typescript.js"(l,c){"use strict";K();var d=or(),f=ho(),x=uo(),g={AbstractKeyword:126,SourceFile:308,PropertyDeclaration:169};function A(I){for(;I&&I.kind!==g.SourceFile;)I=I.parent;return I}function T(I){let{illegalDecorators:C}=I;if(!d(C))return;let[{expression:F}]=C,_=A(F),[N,$]=[F.pos,F.end].map(X=>{let{line:L,character:R}=_.getLineAndCharacterOfPosition(X);return{line:L+1,column:R}});x({loc:{start:N,end:$}},"Decorators are not valid here.")}function S(I,C){I.kind!==g.PropertyDeclaration||I.modifiers&&!I.modifiers.some(F=>F.kind===g.AbstractKeyword)||I.initializer&&C.value===null&&x(C,"Abstract property cannot have an initializer")}function O(I,C){let{esTreeNodeToTSNodeMap:F,tsNodeToESTreeNodeMap:_}=C.tsParseResult;f(I,N=>{let $=F.get(N);if(!$)return;let X=_.get($);X===N&&(T($),S($,X))})}c.exports={throwErrorForInvalidNodes:O}}}),ld=W({"src/language-js/parse/postprocess/index.js"(l,c){"use strict";K();var{locStart:d,locEnd:f}=no(),x=rd(),g=ad(),A=nd(),T=ho(),{throwErrorForInvalidNodes:S}=od(),O=uo();function I(N,$){if($.parser==="typescript"&&/@|abstract/.test($.originalText)&&S(N,$),$.parser!=="typescript"&&$.parser!=="flow"&&$.parser!=="acorn"&&$.parser!=="espree"&&$.parser!=="meriyah"){let L=new Set;N=T(N,R=>{R.leadingComments&&R.leadingComments.some(g)&&L.add(d(R))}),N=T(N,R=>{if(R.type==="ParenthesizedExpression"){let{expression:h}=R;if(h.type==="TypeCastExpression")return h.range=R.range,h;let Y=d(R);if(!L.has(Y))return h.extra=Object.assign(Object.assign({},h.extra),{},{parenthesized:!0}),h}})}return N=T(N,L=>{switch(L.type){case"ChainExpression":return C(L.expression);case"LogicalExpression":{if(F(L))return _(L);break}case"VariableDeclaration":{let R=A(L.declarations);R&&R.init&&X(L,R);break}case"TSParenthesizedType":return x(L.typeAnnotation)||L.typeAnnotation.type==="TSThisType"||(L.typeAnnotation.range=[d(L),f(L)]),L.typeAnnotation;case"TSTypeParameter":if(typeof L.name=="string"){let R=d(L);L.name={type:"Identifier",name:L.name,range:[R,R+L.name.length]}}break;case"ObjectExpression":if($.parser==="typescript"){let R=L.properties.find(h=>h.type==="Property"&&h.value.type==="TSEmptyBodyFunctionExpression");R&&O(R.value,"Unexpected token.")}break;case"SequenceExpression":{let R=A(L.expressions);L.range=[d(L),Math.min(f(R),f(L))];break}case"TopicReference":$.__isUsingHackPipeline=!0;break;case"ExportAllDeclaration":{let{exported:R}=L;if($.parser==="meriyah"&&R&&R.type==="Identifier"){let h=$.originalText.slice(d(R),f(R));(h.startsWith('"')||h.startsWith("'"))&&(L.exported=Object.assign(Object.assign({},L.exported),{},{type:"Literal",value:L.exported.name,raw:h}))}break}}}),N;function X(L,R){$.originalText[f(R)]!==";"&&(L.range=[d(L),f(R)])}}function C(N){switch(N.type){case"CallExpression":N.type="OptionalCallExpression",N.callee=C(N.callee);break;case"MemberExpression":N.type="OptionalMemberExpression",N.object=C(N.object);break;case"TSNonNullExpression":N.expression=C(N.expression);break}return N}function F(N){return N.type==="LogicalExpression"&&N.right.type==="LogicalExpression"&&N.operator===N.right.operator}function _(N){return F(N)?_({type:"LogicalExpression",operator:N.operator,left:_({type:"LogicalExpression",operator:N.operator,left:N.left,right:N.right.left,range:[d(N.left),f(N.right.left)]}),right:N.right.right,range:[d(N),f(N)]}):N}c.exports=I}}),co=W({"node_modules/@babel/parser/lib/index.js"(l){"use strict";K(),Object.defineProperty(l,"__esModule",{value:!0});function c(t,r){if(t==null)return{};var e={},s=Object.keys(t),i,a;for(a=0;a<s.length;a++)i=s[a],!(r.indexOf(i)>=0)&&(e[i]=t[i]);return e}var d=class{constructor(t,r,e){this.line=void 0,this.column=void 0,this.index=void 0,this.line=t,this.column=r,this.index=e}},f=class{constructor(t,r){this.start=void 0,this.end=void 0,this.filename=void 0,this.identifierName=void 0,this.start=t,this.end=r}};function x(t,r){let{line:e,column:s,index:i}=t;return new d(e,s+r,i+r)}var g={SyntaxError:"BABEL_PARSER_SYNTAX_ERROR",SourceTypeModuleError:"BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED"},A=function(t){let r=arguments.length>1&&arguments[1]!==void 0?arguments[1]:t.length-1;return{get(){return t.reduce((e,s)=>e[s],this)},set(e){t.reduce((s,i,a)=>a===r?s[i]=e:s[i],this)}}},T=(t,r,e)=>Object.keys(e).map(s=>[s,e[s]]).filter(s=>{let[,i]=s;return!!i}).map(s=>{let[i,a]=s;return[i,typeof a=="function"?{value:a,enumerable:!1}:typeof a.reflect=="string"?Object.assign({},a,A(a.reflect.split("."))):a]}).reduce((s,i)=>{let[a,n]=i;return Object.defineProperty(s,a,Object.assign({configurable:!0},n))},Object.assign(new t,r)),S={ImportMetaOutsideModule:{message:`import.meta may appear only with 'sourceType: "module"'`,code:g.SourceTypeModuleError},ImportOutsideModule:{message:`'import' and 'export' may appear only with 'sourceType: "module"'`,code:g.SourceTypeModuleError}},O={ArrayPattern:"array destructuring pattern",AssignmentExpression:"assignment expression",AssignmentPattern:"assignment expression",ArrowFunctionExpression:"arrow function expression",ConditionalExpression:"conditional expression",CatchClause:"catch clause",ForOfStatement:"for-of statement",ForInStatement:"for-in statement",ForStatement:"for-loop",FormalParameters:"function parameter list",Identifier:"identifier",ImportSpecifier:"import specifier",ImportDefaultSpecifier:"import default specifier",ImportNamespaceSpecifier:"import namespace specifier",ObjectPattern:"object destructuring pattern",ParenthesizedExpression:"parenthesized expression",RestElement:"rest element",UpdateExpression:{true:"prefix operation",false:"postfix operation"},VariableDeclarator:"variable declaration",YieldExpression:"yield expression"},I=t=>{let{type:r,prefix:e}=t;return r==="UpdateExpression"?O.UpdateExpression[String(e)]:O[r]},C={AccessorIsGenerator:t=>{let{kind:r}=t;return`A ${r}ter cannot be a generator.`},ArgumentsInClass:"'arguments' is only allowed in functions and class methods.",AsyncFunctionInSingleStatementContext:"Async functions can only be declared at the top level or inside a block.",AwaitBindingIdentifier:"Can not use 'await' as identifier inside an async function.",AwaitBindingIdentifierInStaticBlock:"Can not use 'await' as identifier inside a static block.",AwaitExpressionFormalParameter:"'await' is not allowed in async function parameters.",AwaitNotInAsyncContext:"'await' is only allowed within async functions and at the top levels of modules.",AwaitNotInAsyncFunction:"'await' is only allowed within async functions.",BadGetterArity:"A 'get' accesor must not have any formal parameters.",BadSetterArity:"A 'set' accesor must have exactly one formal parameter.",BadSetterRestParameter:"A 'set' accesor function argument must not be a rest parameter.",ConstructorClassField:"Classes may not have a field named 'constructor'.",ConstructorClassPrivateField:"Classes may not have a private field named '#constructor'.",ConstructorIsAccessor:"Class constructor may not be an accessor.",ConstructorIsAsync:"Constructor can't be an async function.",ConstructorIsGenerator:"Constructor can't be a generator.",DeclarationMissingInitializer:t=>{let{kind:r}=t;return`Missing initializer in ${r} declaration.`},DecoratorArgumentsOutsideParentheses:"Decorator arguments must be moved inside parentheses: use '@(decorator(args))' instead of '@(decorator)(args)'.",DecoratorBeforeExport:"Decorators must be placed *before* the 'export' keyword. You can set the 'decoratorsBeforeExport' option to false to use the 'export @decorator class {}' syntax.",DecoratorConstructor:"Decorators can't be used with a constructor. Did you mean '@dec class { ... }'?",DecoratorExportClass:"Using the export keyword between a decorator and a class is not allowed. Please use `export @dec class` instead.",DecoratorSemicolon:"Decorators must not be followed by a semicolon.",DecoratorStaticBlock:"Decorators can't be used with a static block.",DeletePrivateField:"Deleting a private field is not allowed.",DestructureNamedImport:"ES2015 named imports do not destructure. Use another statement for destructuring after the import.",DuplicateConstructor:"Duplicate constructor in the same class.",DuplicateDefaultExport:"Only one default export allowed per module.",DuplicateExport:t=>{let{exportName:r}=t;return`\`${r}\` has already been exported. Exported identifiers must be unique.`},DuplicateProto:"Redefinition of __proto__ property.",DuplicateRegExpFlags:"Duplicate regular expression flag.",ElementAfterRest:"Rest element must be last element.",EscapedCharNotAnIdentifier:"Invalid Unicode escape.",ExportBindingIsString:t=>{let{localName:r,exportName:e}=t;return`A string literal cannot be used as an exported binding without \`from\`.
