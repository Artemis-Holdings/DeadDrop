...
`)+`
<<<<<<< HEAD
`}};e._defineProperty(i,"defaults",y),n.Document=i,n.defaultOptions=h,n.scalarOptions=d}}),zr=D({"node_modules/yaml/dist/index.js"(n){"use strict";Y();var e=Hr(),r=Gr(),c=ot(),h=Me(),d=at();ke();function y(C){let q=arguments.length>1&&arguments[1]!==void 0?arguments[1]:!0,R=arguments.length>2?arguments[2]:void 0;R===void 0&&typeof q=="string"&&(R=q,q=!0);let B=Object.assign({},r.Document.defaults[r.defaultOptions.version],r.defaultOptions);return new c.Schema(B).createNode(C,q,R)}var E=class extends r.Document{constructor(C){super(Object.assign({},r.defaultOptions,C))}};function I(C,q){let R=[],B;for(let U of e.parse(C)){let f=new E(q);f.parse(U,B),R.push(f),B=f}return R}function S(C,q){let R=e.parse(C),B=new E(q).parse(R[0]);if(R.length>1){let U="Source contains multiple documents; please use YAML.parseAllDocuments()";B.errors.unshift(new h.YAMLSemanticError(R[1],U))}return B}function M(C,q){let R=S(C,q);if(R.warnings.forEach(B=>d.warn(B)),R.errors.length>0)throw R.errors[0];return R.toJSON()}function T(C,q){let R=new E(q);return R.contents=C,String(R)}var P={createNode:y,defaultOptions:r.defaultOptions,Document:E,parse:M,parseAllDocuments:I,parseCST:e.parse,parseDocument:S,scalarOptions:r.scalarOptions,stringify:T};n.YAML=P}}),Je=D({"node_modules/yaml/index.js"(n,e){Y(),e.exports=zr().YAML}}),Zr=D({"node_modules/yaml/dist/util.js"(n){"use strict";Y();var e=ke(),r=Me();n.findPair=e.findPair,n.parseMap=e.resolveMap,n.parseSeq=e.resolveSeq,n.stringifyNumber=e.stringifyNumber,n.stringifyString=e.stringifyString,n.toJSON=e.toJSON,n.Type=r.Type,n.YAMLError=r.YAMLError,n.YAMLReferenceError=r.YAMLReferenceError,n.YAMLSemanticError=r.YAMLSemanticError,n.YAMLSyntaxError=r.YAMLSyntaxError,n.YAMLWarning=r.YAMLWarning}}),Xr=D({"node_modules/yaml/util.js"(n){Y();var e=Zr();n.findPair=e.findPair,n.toJSON=e.toJSON,n.parseMap=e.parseMap,n.parseSeq=e.parseSeq,n.stringifyNumber=e.stringifyNumber,n.stringifyString=e.stringifyString,n.Type=e.Type,n.YAMLError=e.YAMLError,n.YAMLReferenceError=e.YAMLReferenceError,n.YAMLSemanticError=e.YAMLSemanticError,n.YAMLSyntaxError=e.YAMLSyntaxError,n.YAMLWarning=e.YAMLWarning}}),en=D({"node_modules/yaml-unist-parser/lib/yaml.js"(n){"use strict";Y(),n.__esModule=!0;var e=Je();n.Document=e.Document;var r=Je();n.parseCST=r.parseCST;var c=Xr();n.YAMLError=c.YAMLError,n.YAMLSyntaxError=c.YAMLSyntaxError,n.YAMLSemanticError=c.YAMLSemanticError}}),tn=D({"node_modules/yaml-unist-parser/lib/parse.js"(n){"use strict";Y(),n.__esModule=!0;var e=xt(),r=Gt(),c=zt(),h=Zt(),d=Yr(),y=ze(),E=Fr(),I=Vr(),S=Qr(),M=Ur(),T=Kr(),P=xr(),C=en();function q(R){var B=C.parseCST(R);M.addOrigRange(B);for(var U=B.map(function(k){return new C.Document({merge:!1,keepCstNodes:!0}).parse(k)}),f=new e.default(R),i=[],t={text:R,locator:f,comments:i,transformOffset:function(k){return I.transformOffset(k,t)},transformRange:function(k){return S.transformRange(k,t)},transformNode:function(k){return d.transformNode(k,t)},transformContent:function(k){return y.transformContent(k,t)}},s=0,a=U;s<a.length;s++)for(var m=a[s],g=0,u=m.errors;g<u.length;g++){var p=u[g];if(!(p instanceof C.YAMLSemanticError&&p.message==='Map keys must be unique; "<<" is repeated'))throw E.transformError(p,t)}U.forEach(function(k){return h.removeCstBlankLine(k.cstNode)});var L=c.createRoot(t.transformRange({origStart:0,origEnd:t.text.length}),U.map(t.transformNode),i);return r.attachComments(L),P.updatePositions(L),T.removeFakeNodes(L),L}n.parse=q}}),rn=D({"node_modules/yaml-unist-parser/lib/index.js"(n){"use strict";Y(),n.__esModule=!0;var e=(ie(),se(te));e.__exportStar(tn(),n)}});Y();var nn=Lt(),{hasPragma:sn}=At(),{locStart:an,locEnd:on}=Nt();function ln(n){let{parse:e}=rn();try{let r=e(n);return delete r.comments,r}catch(r){throw r!=null&&r.position?nn(r.message,r.position):r}}var cn={astFormat:"yaml",parse:ln,hasPragma:sn,locStart:an,locEnd:on};lt.exports={parsers:{yaml:cn}}});return un();});
=======
